	...
	def __init__(self):
		...
		if not self.button_map:
			self.button_map = {
				...
				'btnDownDolphin' : None,
				'btnLeftDolphin' : None,
				'btnRightDolphin' : None,
				'btnStartDolphin' : None,
				'btnADolphin' : None,
				'btnBDolphin' : None,
				'btnXDolphin' : None,
				'btnYDolphin' : None,
				'btnZDolphin' : None,
				'btnLTriggerDolphin' : None,
				...
				'btnLeftStickRightDolphin' : None,
				'btnRightStickUpDolphin' : None,
				'btnRightStickDownDolphin' : None,
				'btnRightStickLeftDolphin' : None,
	...
	def _setup_configs(self):
		...
		config = {
			'GCPad1' : {
				...
				'Buttons/A' : BUTTON_CODE_MAP[self.button_map['btnADolphin']],
				'Buttons/B' : BUTTON_CODE_MAP[self.button_map['btnBDolphin']],
				'Buttons/X' : BUTTON_CODE_MAP[self.button_map['btnXDolphin']],
				'Buttons/Y' : BUTTON_CODE_MAP[self.button_map['btnYDolphin']],
				'Buttons/Z' : BUTTON_CODE_MAP[self.button_map['btnZDolphin']],
				'Buttons/Start' : BUTTON_CODE_MAP[self.button_map['btnStartDolphin']],
				'Main Stick/Up' : BUTTON_CODE_MAP[self.button_map['btnLeftStickUpDolphin']],
				'Main Stick/Down' : BUTTON_CODE_MAP[self.button_map['btnLeftStickDownDolphin']],
				'Main Stick/Left' : BUTTON_CODE_MAP[self.button_map['btnLeftStickLeftDolphin']],
				'Main Stick/Right' : BUTTON_CODE_MAP[self.button_map['btnLeftStickRightDolphin']],
				...
				'C-Stick/Up' : BUTTON_CODE_MAP[self.button_map['btnRightStickUpDolphin']],
				'C-Stick/Down' : BUTTON_CODE_MAP[self.button_map['btnRightStickDownDolphin']],
				'C-Stick/Left' : BUTTON_CODE_MAP[self.button_map['btnRightStickLeftDolphin']],
				'C-Stick/Right' : BUTTON_CODE_MAP[self.button_map['btnRightStickRightDolphin']],
				...
				'Triggers/L' : BUTTON_CODE_MAP[self.button_map['btnLShoulderDolphin']],
				'Triggers/R' : BUTTON_CODE_MAP[self.button_map['btnRShoulderDolphin']],
				'Triggers/L-Analog' : BUTTON_CODE_MAP[self.button_map['btnLTriggerDolphin']],
				'Triggers/R-Analog' : BUTTON_CODE_MAP[self.button_map['btnRTriggerDolphin']],
				'D-Pad/Up' : BUTTON_CODE_MAP[self.button_map['btnUpDolphin']],
				'D-Pad/Down' : BUTTON_CODE_MAP[self.button_map['btnDownDolphin']],
				'D-Pad/Left' : BUTTON_CODE_MAP[self.button_map['btnLeftDolphin']],
				'D-Pad/Right' : BUTTON_CODE_MAP[self.button_map['btnRightDolphin']],
			}
		}
