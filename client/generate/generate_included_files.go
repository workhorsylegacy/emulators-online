...
func main() {
	...
	file_names := []string {
		...
		"client/identify_games/db_dreamcast_official_eu.json",
		"client/identify_games/db_dreamcast_official_jp.json",
		"client/identify_games/db_dreamcast_official_us.json",
		"client/identify_games/db_dreamcast_unofficial.json",
